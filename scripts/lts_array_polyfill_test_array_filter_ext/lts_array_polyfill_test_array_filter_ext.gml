...
function lts_array_polyfill_test_array_filter_ext(){
	...
	assert_equal(fixture.array, [1, 6, 6], "array_filter_ext offset false 1b");
	fixture.reset();
	assert_equal(array_filter_ext(fixture.array, isEven, -2), 1, "array_filter_ext offset false 2a");
	assert_equal(fixture.array, [1, 6, 6], "array_filter_ext offset false 2b");
	...
	assert_equal(fixture.array, [1, 2, 6, 6, 9], "array_filter_ext range false 1b");
	fixture.reset();
	assert_equal(array_filter_ext(fixture.array, isEven, -2, -3), 2, "array_filter_ext range false 2a");
	assert_equal(fixture.array, [1, 2, 2, 6, 9], "array_filter_ext range false 2b");
	...
	assert_equal(fixture.array, [1, 1, 3, 3, 5, 9, 9], "array_filter_ext range false 3b");
	fixture.reset();
	assert_equal(array_filter_ext(fixture.array, isEven, -3, -3), 0, "array_filter_ext range false 4a");
	assert_equal(fixture.array, [1, 1, 3, 3, 5, 9, 9], "array_filter_ext range false 4b");
	#endregion
}